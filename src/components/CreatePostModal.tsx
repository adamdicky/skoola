        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[700px]">
                ...
                <div className="flex flex-col gap-5 py-2">
                    ...
                    {/* Content */}
                    <div className="flex flex-col gap-1">
                        <Label htmlFor="content" className='text-[#243056] pb-1 font-semibold'>Content*</Label>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        >
                            ...
                            <a className='font-small text-[#6E7793] italic'>Click here or drag and drop (3 images maximum)</a>
                        </div>
